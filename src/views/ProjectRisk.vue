  ...
  <div class="app-shell">
    ...
    <header class="app-topbar">
      ...
      <div class="topbar-right">
        ...
        <button class="icon-btn notification-link" type="button" @click="handleOpenNotifications"><span class="material-symbols-outlined">notifications</span></button>
